    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 m-8 text-gray-600">
      ...
      <div className="col-span-2 p-10">
        ...
        <ul className="m-4 space-y-3">
          <li>
            <a href="https://github.com/kissy24" className="flex items-center p-3 text-base font-bold rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow">
              <img src={githubImage} className="w-8" alt="github" />
              <span className="ms-4">GitHub</span>
            </a>
          </li>
          <li>
            <a href="https://twitter.com/kissy_24" className="flex items-center p-3 text-base font-bold rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow">
              <img src={xImage} className="w-8" alt="x" />
              <span className="ms-4">X(Twitter)</span>
            </a>
          </li>
          <li>
            <a href="https://youtrust.jp/users/kissy24" className="flex items-center p-3 text-base font-bold rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow">
              <img src={youtrustImage} className="w-8" alt="youtrust" />
              <span className="ms-4">Youtrust</span>
            </a>
          </li>
          <li>
            <a href="https://qiita.com/kissy24" className="flex items-center p-3 text-base font-bold rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow">
              <img src={qiitaImage} className="w-8" alt="qiita" />
              <span className="ms-4">Qiita</span>
            </a>
          </li>
          <li>
            <a href="https://sizu.me/kissy24" className="flex items-center p-3 text-base font-bold rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow">
